...
\end{figure}
	...
	Can you find triangular numbers (of the form $1+2+3+\cdots+a$) that are also perfect squares ($b^2$ for an integer $b$)?	
\end{frame}

\begin{frame}
  \frametitle{Triangular numbers}
  Can we find a formula for the $a$th triangular number:
  \[T_a = 1+2+3+\cdots + a \]
